  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-white dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(200%-5px)] data-[state=unchecked]:translate-x-[calc(15%)]"
        )}
      />
    </SwitchPrimitive.Root>
  )
